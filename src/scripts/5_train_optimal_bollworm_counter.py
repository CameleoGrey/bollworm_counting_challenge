...
save(bollworm_counter, os.path.join(models_dir, "first_order_bollworm_counter_1280.pkl"))
bollworm_counter = load( os.path.join(models_dir, "first_order_bollworm_counter_1280.pkl") )
bollworm_counter.eval_on_cached_labeled_df(train_cache_dir, 
                                           verbose_progress=False, 
                                           verbose_metrics=True, 
                                           use_hyperparams_predictor=False)
...
#bollworm_counter.image_feature_extractor = OptimalBollwormCounter(os.path.join( models_dir, "1_baseline_1280.pt" )).image_feature_extractor
#save(bollworm_counter, os.path.join(models_dir, "first_order_bollworm_counter_1280.pkl"))
###############
...
save(second_order_dataset, os.path.join(models_dir, "0_baseline_second_order_dataset_1280_efficientnetv2.pkl"))"""
second_order_dataset = load( os.path.join(models_dir, "0_baseline_second_order_dataset_1280_efficientnetv2.pkl") )
bollworm_counter = load( os.path.join(models_dir, "first_order_bollworm_counter_1280.pkl") )
bollworm_counter.second_order_hyperparameters_optimization(second_order_dataset, random_seed=45)
save(bollworm_counter, os.path.join(models_dir, "second_order_bollworm_counter_1280.pkl"))
